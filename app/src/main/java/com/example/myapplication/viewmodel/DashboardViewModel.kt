...
class DashboardViewModel : ViewModel() {
    ...
    private val _payrollStructuresData = MutableLiveData<List<PayStructure>>()
    val payrollStructuresData: LiveData<List<PayStructure>> get() = _payrollStructuresData
    ...
    */
    ...
    fun fetchPayrollStructures() {
        viewModelScope.launch {
            ...
            val result: Result<List<PayStructure>> = combinedRepository.fetchPayrollStructures()
