...
class SessionManager(context: Context) {
    ...
    fun saveEmpIdPms(empId: String) {
        ...
        android.util.Log.d("SessionManager", "✅ PMS empId saved to session: $empId")
    }

    fun fetchEmpIdPms(): String? {
        val empId = prefs.getString(EMP_ID_PMS, null)
        android.util.Log.d("SessionManager", "🔍 Fetching PMS empId from session: $empId")
        return empId
    }
