...
class FilterPayslipActivity : AppCompatActivity() {
    ...
    private lateinit var tvEmailCard: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvEmailCard = findViewById(R.id.tvEmailCard)
        ...
        val empName = MyApplication.sessionManager.fetchUserName() ?: "N/A"
        val empId = MyApplication.sessionManager.fetchEmpIdSecondary() ?: "N/A"
        val empEmail = MyApplication.sessionManager.fetchUserEmail() ?: "N/A"

        tvEmployeeNameCard.text = "Employee : $empName"
        tvEmployeeIdCard.text = "Employee ID : $empId"
        tvEmailCard.text = "Email : $empEmail"
